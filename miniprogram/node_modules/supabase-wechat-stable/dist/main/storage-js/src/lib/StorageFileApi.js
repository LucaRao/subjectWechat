...
class StorageFileApi {
    ...
    move(fromPath, toPath) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield _fetch(`${this.url}/object/move`, { bucketId: this.bucketId, sourceKey: fromPath, destinationKey: toPath }, { header: this.headers });
    ...
    remove(paths) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield _fetch(`${this.url}/object/${this.bucketId}`, { prefixes: paths }, { header: this.headers });
                return { data, error: null };
            }
            catch (error) {
                return { data: null, error };
    ...
    list(path, options, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield _fetch(`${this.url}/object/list/${this.bucketId}`, body, { header: this.headers }, parameters);
                return { data, error: null };
            }
            catch (error) {
                return { data: null, error };
